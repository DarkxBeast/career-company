...
export default function Hero() {
  ...
  const studentSlides = {
    mobile: [
      ...
      [4],
      [5],
      [6], // One card per slide on mobile
    ],
    tablet: [
      [0, 1],
      [2, 3],
      [4, 5],
      [6], // Two cards per slide on tablet
    ],
    desktop: [
      [0, 1, 2, 3],
      [3, 4, 5, 6], // Original desktop layout
    ],
  };
  ...
  const institutionSlides = {
    mobile: [
      ...
      [1],
      [2],
      [3], // One card per slide on mobile
    ],
    tablet: [
      [0, 1],
      [2, 3], // Two cards per slide on tablet
    ],
    desktop: [
  ...
  const companySlides = {
    mobile: [
      ...
      [2],
      [3],
      [4], // One card per slide on mobile
    ],
    tablet: [
      [0, 1],
      [2, 3],
      [4], // Two cards per slide on tablet
    ],
    desktop: [
      [0, 1, 2, 3],
      [1, 2, 3, 4], // Original desktop layout
    ],
  };
  ...
  const studentSlideCount =
    studentSlides[screenSize as keyof typeof studentSlides].length;
  const institutionSlideCount =
    institutionSlides[screenSize as keyof typeof institutionSlides].length;
  const companySlideCount =
    companySlides[screenSize as keyof typeof companySlides].length;
  ...
  const getVisibleStudentCards = () => {
    const currentSlides =
      studentSlides[screenSize as keyof typeof studentSlides];
  ...
  const getVisibleInstitutionCards = () => {
    const currentSlides =
      institutionSlides[screenSize as keyof typeof institutionSlides];
  ...
  const getVisibleCompanyCards = () => {
    const currentSlides =
      companySlides[screenSize as keyof typeof companySlides];
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-[#FF9E44] text-[38px] sm:text-[46px] md:text-[64px] font-extrabold relative inline-block">
            Clarity
            <span className="absolute bottom-0 left-0 w-full h-[3px] sm:h-[4px] md:h-[5px] bg-[#FF9E44] rounded-full"></span>
          </span>{" "}
          in your career.
        </motion.h1>
        <motion.p
        ...
        >
          ...
          faster with clarity.
          <br /> Help institutions accelerate their placements and provide
