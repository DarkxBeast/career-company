        ...
        <div className="py-12 md:py-16 px-6 md:px-32 flex flex-col md:flex-row gap-16 md:gap-20 flex-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 md:flex md:flex-1 gap-12 md:gap-0">
            ...
            >
              ...
              <ul className="space-y-4">
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/" className="text-gray-700 hover:text-black transition-colors inline-block">
                    Home
                  </Link>
                </motion.li>
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/companies" className="text-gray-700 hover:text-black transition-colors inline-block">
                    For Companies
                  </Link>
                </motion.li>
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/institutions" className="text-gray-700 hover:text-black transition-colors inline-block">
                    For Institutions
                  </Link>
                </motion.li>
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/students" className="text-gray-700 hover:text-black transition-colors inline-block">
                    For Students
                  </Link>
                </motion.li>
              </ul>
            ...
            >
              ...
              <ul className="space-y-4">
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/support" className="text-gray-700 hover:text-black transition-colors inline-block">
                    Customer Support
                  </Link>
                </motion.li>
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/terms" className="text-gray-700 hover:text-black transition-colors inline-block">
                    Terms & Conditions
                  </Link>
                </motion.li>
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/privacy" className="text-gray-700 hover:text-black transition-colors inline-block">
                    Privacy Policy
                  </Link>
                </motion.li>
              </ul>
            ...
            >
              ...
              <ul className="space-y-4">
                <motion.li variants={linkVariants} whileHover="hover">
                  <Link href="/join-mentor" className="text-gray-700 hover:text-black transition-colors inline-block">
                    Join us as a Mentor
                  </Link>
                </motion.li>
              </ul>
